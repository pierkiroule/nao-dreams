 ...
 if(phase==="entry")content=<main className="grand-o-entry">
  ...
  <div className="odyssey-intro">
   ...
   <div className="odyssey-story">
    ...
    <p>Scanne-la. Choisis trois horizons oniriques parmi les grandes cultures du monde. Leurs fils se rencontrent, se tissent et donnent naissance à un rêve inédit, inspiré de récits, de mythes et de traditions réels.</p>
    <p>Puis laisse ce rêve rejoindre le Grand O•°, un océan vivant où les rêves se répondent, se croisent et continuent leur voyage.</p>
    <p>Quand ton odyssée est terminée, passe la noix à quelqu’un d’autre.</p>
    <p className="odyssey-closing">Car les plus beaux rêves sont ceux qui voyagent de main en main.</p>
   </div>
