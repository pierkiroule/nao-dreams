...
export default function NaoOdyssey({onLeave}:Props){
 ...
 let content;
 if(phase==="entry")content=<main className="grand-o-entry"><NaoLogo/><div className="boat-horizon"><NaoBoat size="hero"/></div><section className="odyssey-introduction"><h1>L’Odyssée de Nao Dream</h1><p className="odyssey-subtitle">La petite noix qui voyage de main en main pour réveiller les rêves du monde •°</p><div className="odyssey-story"><p>Chaque noix porte en elle une invitation.</p><p>Scanne-la. Choisis trois horizons oniriques parmi les grandes cultures du monde. Leurs fils se rencontrent, se tissent et donnent naissance à un rêve inédit, inspiré de récits, de mythes et de traditions réels.</p><p>Puis laisse ce rêve rejoindre le Grand O•°, un océan vivant où les rêves se répondent, se croisent et continuent leur voyage.</p><p>Quand ton odyssée est terminée, passe la noix à quelqu’un d’autre.</p><p>Car les plus beaux rêves sont ceux qui voyagent de main en main.</p></div></section><button className="enter-ocean" onClick={()=>setPhase("choosing")}><span>Entrer dans le Grand O•°</span><i/></button><details className="system-tide"><summary>État du courant</summary><TestEnvironmentPanel/></details>{onLeave&&<button className="leave-ocean" onClick={onLeave}>Explorer autrement</button>}</main>;
